...
var icons = [
  { type: "button", name: "pencil", title: "Edit Node", iconTransform: 't10,7', transform: 't25,150', path: ["M27 0c2.761 0 5 2.239 5 5 0 1.126-0.372 2.164-1 3l-2 2-7-7 2-2c0.836-0.628 1.874-1 3-1zM2 23l-2 9 9-2 18.5-18.5-7-7-18.5 18.5zM22.362 11.362l-14 14-1.724-1.724 14-14 1.724 1.724z"]},
  { type: "button", name: "arrows", title: "Create Arrows", iconTransform: 't10,10', transform: 't25,200', path: [
  ...
  { type: "button", name: "delete", title: "Delete Node", iconTransform: 't10,7', transform: 't25,250', path: [
    ...
    { type: "button", name: "clear", title: "Clear All", iconTransform: 't10,7 s1.2', transform: 't25,300', path: [
      ...
      mousedown: "var set = paper.selectAll(\".node, .arrow\");set.remove()"
    }
]
