var symbol_icon_pencil = toolbox.symbol(0,0,100,100).attr({id:'icon-pencil', preserveAspectRatio: 'xMinYMin meet'});
...
var icon_pencil_button = toolbox.use('icon-pencil').attr({class:'line--grid'}).append(icon_pencil_button_title);

icon_pencil_button.transform('t25,150')
